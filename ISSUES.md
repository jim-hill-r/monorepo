TODO: Update the start-a-new-task.yml workflow to not use github issues and rather kick it off some other way.    
TODO: Remove the github pages workflow and docs folder.   
