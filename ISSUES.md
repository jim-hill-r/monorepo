TODO: Move one directory from the projects directory up one level into the root directory. Don't remove this TODO until there is nothing left in the projects directory.
