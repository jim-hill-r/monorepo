...
- ✓ COMPLETED: Create cast/core directory structure
- ✓ COMPLETED: Move cast_core files to cast/core directory
...
- ✓ COMPLETED: Run `cast ci` on all moved projects
...
- ✓ COMPLETED: Remove old cast, cast_cli, cast_vscode directories
- ✓ COMPLETED: Remove these TODO items from ISSUES.md once complete
