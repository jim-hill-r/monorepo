...
- TODO: Generate 365 recipes with as much variety as possible and store them in the content folder, one per day.
- TODO: `dx bundle --release` command should be runnable from within the web project not in the root of the workspace.