...
- TODO: There is still a small gap between sidebar and header. The sidebar should touch the header exactly.
- TODO: The title for the header should be left aligned next to the hamburger menu.
- TODO: The sidebar recipes should be displaying "this week's recipes". If it is December 30, then it should have 7 entries (`Sun, 28-Dec`, `Mon, 29-Dec`, `Tue, 30-Dec`, `Wed, 31-Dec`, `Thu, 1-Jan`, `Fri, 2-Jan`, `Sat, 3-Jan`)
